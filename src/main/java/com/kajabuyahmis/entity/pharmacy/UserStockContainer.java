...
public class UserStockContainer implements Serializable {
    ...
    @OneToMany(mappedBy = "userStockContainer",fetch = FetchType.LAZY)
...
//    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof UserStockContainer)) {
            return false;
        }
        UserStockContainer other = (UserStockContainer) object;
    ...
    public String toString() {
        return "com.kajabuyahmis.entity.pharmacy.UserStockContainer[ id=" + id + " ]";
    }
