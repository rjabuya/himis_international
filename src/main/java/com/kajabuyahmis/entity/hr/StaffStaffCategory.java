...
@Entity
@XmlRootElement
public class StaffStaffCategory implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof StaffStaffCategory)) {
            return false;
        }
        StaffStaffCategory other = (StaffStaffCategory) object;
    ...
    public String toString() {
        return "com.kajabuyahmis.entity.hr.StaffStaffCategory[ id=" + id + " ]";
    }
