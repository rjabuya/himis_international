...
import com.kajabuyahmis.bean.common.EnumController;
...
import com.kajabuyahmis.data.PaymentMethodValue;
import com.kajabuyahmis.data.dataStructure.BillsTotals;
import com.kajabuyahmis.data.dataStructure.CashierSummeryData;
...
//            uCash += (newC.getCash() + newR.getCash());
    ...
    private List<Object> userBillTotalsWithPaymentMethods(WebUser w, Bill billClass, BillType billType) {
        ...
        sql = "select new com.kajabuyahmis.data.PaymentMethodValue(b.paymentMethod, sum(b.netTotal+b.vat))"
                + " from Bill b "
                + " where type(b)=:bill "
                + " and b.creater=:cret "
