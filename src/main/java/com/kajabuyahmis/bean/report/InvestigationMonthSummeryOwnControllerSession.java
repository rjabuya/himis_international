...
import com.kajabuyahmis.bean.lab.InvestigationController;
...
import com.kajabuyahmis.data.dataStructure.InvestigationSummeryData;
import com.kajabuyahmis.data.dataStructure.ItemInstitutionCollectingCentreCountRow;
...
//        }
    ...
    public void createIxCountByInstitutionAndCollectingCentreOld() {
        ...
        jpql = "Select new com.kajabuyahmis.data.dataStructure.ItemInstitutionCollectingCentreCountRow(bi.item, count(bi), bi.bill.institution, bi.bill.collectingCentre) "
                + " from BillItem bi "
                + " join bi.bill b "
        ...
        m = new HashMap();
        jpql = "Select new com.kajabuyahmis.data.dataStructure.ItemInstitutionCollectingCentreCountRow(bi.item, count(bi), bi.bill.institution) "
                + " from BillItem bi "
                + " join bi.bill b "
                + " join b.institution ins "
                + " join bi.item item "
...
//        countTotal = billed - (refunded + cancelled);
    ...
    private void setCountTotalWithoutC(InvestigationSummeryData is, Item w) {
        ...
        temMap.put("ixtype", com.kajabuyahmis.entity.lab.Investigation.class);
