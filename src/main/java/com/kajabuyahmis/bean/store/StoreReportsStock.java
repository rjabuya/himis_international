...
import com.kajabuyahmis.bean.pharmacy.DealerController;
import com.kajabuyahmis.data.BillType;
import com.kajabuyahmis.data.DepartmentType;
import com.kajabuyahmis.data.dataStructure.PharmacyStockRow;
import com.kajabuyahmis.data.dataStructure.StockReportRecord;
...
public class StoreReportsStock implements Serializable {
    ...
    public void fillDepartmentNonEmptyItemStocks() {
        ...
        Map m = new HashMap();
        String sql;
        sql = "select new com.kajabuyahmis.data.dataStructure.PharmacyStockRow"
