...
import com.kajabuyahmis.entity.hr.LeaveForm;
import com.kajabuyahmis.entity.hr.LeaveFormSystem;
...
import com.kajabuyahmis.facade.LeaveFormFacade;
...
//        hm.put("td", td);
    ...
    public boolean errorCheck() {
        ...
        if (staffAdditionalFormController.fetchCurrentSalaryCycle(currentLeaveForm.getFromDate()) != null) {
            ...
            Date nowDate = com.kajabuyahmis.java.CommonFunctions.getEndOfDay();
