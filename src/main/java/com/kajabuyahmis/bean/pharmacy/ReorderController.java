...
import com.kajabuyahmis.bean.common.DepartmentController;
...
import static com.kajabuyahmis.data.DepartmentListMethod.ActiveDepartmentsOfAllInstitutions;
import static com.kajabuyahmis.data.DepartmentListMethod.ActiveDepartmentsOfLoggedInstitution;
import static com.kajabuyahmis.data.DepartmentListMethod.AllDepartmentsOfAllInstitutions;
import static com.kajabuyahmis.data.DepartmentListMethod.AllDepartmentsOfLoggedInstitution;
import static com.kajabuyahmis.data.DepartmentListMethod.AllPharmaciesOfAllInstitutions;
import static com.kajabuyahmis.data.DepartmentListMethod.AllPharmaciesOfLoggedInstitution;
import static com.kajabuyahmis.data.DepartmentListMethod.LoggedDepartmentOnly;
import com.kajabuyahmis.data.DepartmentType;
import com.kajabuyahmis.data.dataStructure.ItemReorders;
...
import com.kajabuyahmis.facade.ReorderFacade;
...
//        dateModel.getAxes().put(AxisType.X, axis);
    ...
    public List<ItemTransactionSummeryRow> findDailyStockAverage(Item item, Department dept, Date fd, Date td) {
        String jpql;
        List<ItemTransactionSummeryRow> rows;
        jpql = "SELECT new com.kajabuyahmis.data.dataStructure.ItemTransactionSummeryRow"
    ...
    public List<ItemTransactionSummeryRow> findDailyTransactions(Item item, Department dept, Date fd, Date td, List<BillType> billTypes) {
        ...
        jpql = "SELECT new com.kajabuyahmis.data.dataStructure.ItemTransactionSummeryRow(s.item, sum(s.qty), FUNC('DATE',s.bill.createdAt)) "
                + " FROM BillItem s "
