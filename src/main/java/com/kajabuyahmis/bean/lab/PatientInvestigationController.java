...
import com.kajabuyahmis.bean.common.SmsController;
import com.kajabuyahmis.bean.common.UtilityController;
import com.kajabuyahmis.bean.report.InstitutionLabSumeryController;
...
import com.kajabuyahmis.data.lab.Dimension;
import com.kajabuyahmis.data.lab.DimensionTestResult;
import com.kajabuyahmis.data.lab.SampleRequestType;
import com.kajabuyahmis.data.lab.SysMex;
import com.kajabuyahmis.data.lab.SysMexAdf1;
import com.kajabuyahmis.data.lab.SysMexAdf2;
import com.kajabuyahmis.ejb.CommonFunctions;
import com.kajabuyahmis.ejb.SmsManagerEjb;
...
import com.kajabuyahmis.entity.lab.PatientReportItemValue;
import com.kajabuyahmis.entity.lab.PatientSample;
...
import com.kajabuyahmis.facade.PatientReportFacade;
import com.kajabuyahmis.facade.PatientReportItemValueFacade;
import com.kajabuyahmis.facade.PatientSampleComponantFacade;
import com.kajabuyahmis.facade.PatientSampleFacade;
import com.kajabuyahmis.facade.ReportItemFacade;
import com.kajabuyahmis.facade.SmsFacade;
...
public class PatientInvestigationController implements Serializable {
    ...
    private String msgFromDimension() {
        ...
        if (dim.getAnalyzerMessageType() == com.kajabuyahmis.data.lab.MessageType.Poll) {
        ...
        } else if (dim.getAnalyzerMessageType() == com.kajabuyahmis.data.lab.MessageType.QueryMessage) {
        ...
        } else if (dim.getAnalyzerMessageType() == com.kajabuyahmis.data.lab.MessageType.ResultMessage) {
        ...
        } else if (dim.getAnalyzerMessageType() == com.kajabuyahmis.data.lab.MessageType.CaliberationResultMessage) {
            dim.prepareResponseForCaliberationResultMessages();
        } else if (dim.getAnalyzerMessageType() == com.kajabuyahmis.data.lab.MessageType.RequestAcceptance) {
...
//                    //////System.out.println("ri is " + ri.getName());
    ...
    public void setCurrentInvestigation(Investigation currentInvestigation) {
        ...
        if (currentInvestigation != null) {
            ...
            sql = "select i from InvestigationItem i where i.retired = false and i.item.id = " + currentInvestigation.getId() + " and i.ixItemType = com.kajabuyahmis.data.InvestigationItemType.Value order by i.cssTop, i.cssLeft";
