...
public class SignController implements Serializable {
     ...
     *
     */
    @FacesConverter("signConverter")
    public static class SignConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            SignController controller = (SignController) facesContext.getApplication().getELResolver().
                    getValue(facesContext.getELContext(), null, "signController");
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof ClinicalFindingItem) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type "
                        + object.getClass().getName() + "; expected type: " + SignController.class.getName());
            }
        }
    }
}
