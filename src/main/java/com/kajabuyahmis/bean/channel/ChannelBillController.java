...
import com.kajabuyahmis.bean.common.DoctorSpecialityController;
...
import com.kajabuyahmis.ejb.ServiceSessionBean;
...
import com.kajabuyahmis.entity.channel.AgentReferenceBook;
import com.kajabuyahmis.entity.membership.MembershipScheme;
import com.kajabuyahmis.entity.membership.PaymentSchemeDiscount;
import com.kajabuyahmis.facade.AgentHistoryFacade;
import com.kajabuyahmis.facade.AgentReferenceBookFacade;
...
//        bi.setItem(getbookingController().getSelectedServiceSession().getOriginatingSession());
    ...
    private List<BillFee> createBillFee(Bill bill, BillItem billItem) {
        ...
        for (ItemFee f : getbookingController().getSelectedServiceSession().getOriginatingSession().getItemFeesActive()) {
