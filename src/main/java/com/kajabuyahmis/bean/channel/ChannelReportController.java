...
import com.kajabuyahmis.data.DoctorDayChannelCount;
import com.kajabuyahmis.data.FeeType;
import com.kajabuyahmis.data.HistoryType;
import com.kajabuyahmis.data.PaymentMethod;
import com.kajabuyahmis.data.PersonInstitutionType;
import com.kajabuyahmis.data.WeekdayDisplay;
import com.kajabuyahmis.data.channel.DateEnum;
import com.kajabuyahmis.data.channel.PaymentEnum;
import com.kajabuyahmis.data.dataStructure.BillsTotals;
import com.kajabuyahmis.data.dataStructure.ChannelDoctor;
import com.kajabuyahmis.data.dataStructure.WebUserBillsTotal;
import com.kajabuyahmis.data.hr.ReportKeyWord;
import com.kajabuyahmis.data.table.String1Value1;
import com.kajabuyahmis.data.table.String1Value3;
import com.kajabuyahmis.ejb.ChannelBean;
...
import com.kajabuyahmis.entity.channel.ArrivalRecord;
import com.kajabuyahmis.facade.AgentHistoryFacade;
import com.kajabuyahmis.facade.ArrivalRecordFacade;
...
import com.kajabuyahmis.facade.ServiceSessionFacade;
...
//                //// // System.out.println("b = " + b.getBillClass());
    ...
    public void createDailyDoctorAnalysis() {
        HashMap m = new HashMap();
        String sql;
        sql = "Select new com.kajabuyahmis.data.DoctorDayChannelCount(bs.bill.staff, bs.sessionDate , count(bs) )"
                + " From BillSession bs "
                + " where bs.bill.staff is not null "
                + " and bs.retired=false "
